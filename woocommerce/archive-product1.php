...
if (have_rows('pro_category_faqs', $term)):
    while (have_rows('pro_category_faqs', $term)) : the_row();
        $sub_value = get_sub_field('question', $term);
        $sub_answer = get_sub_field('answer', $term);
        error_log('Question: ' . $sub_value);
        error_log('Answer: ' . $sub_answer);
        ?>
    ...
    error_log('No FAQs found for the current category.');
endif;
?> 
...
<?php
$term = get_queried_object();
if (have_rows('cat_pro_category_faq', $term)):
    while (have_rows('cat_pro_category_faq', $term)) : the_row();
        $sub_value = get_sub_field('question', $term);
        $sub_answer = get_sub_field('answer', $term);
        error_log('Question: ' . $sub_value);
        error_log('Answer: ' . $sub_answer);
